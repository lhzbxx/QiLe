...
def get_weixin_user_code(id):
	...
	url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfee84b23a06c2b97&redirect_uri=http%3A%2F%2F' + debug + '&response_type=code&scope=snsapi_base&state=' + id  + '#wechat_redirect'
