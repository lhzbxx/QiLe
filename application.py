...
def get_weixin_user_code(id):
	...
	url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfee84b23a06c2b97&redirect_uri=https%3A%2F%2F' + debug + '%2Fpay&response_type=100&scope=snsapi_base&state=123#wechat_redirect'
