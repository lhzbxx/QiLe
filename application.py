...
def get_weixin_user_code(id):
	...
	url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfee84b23a06c2b97&redirect_uri=https%3A%2F%2Fwww.qilefun.com%2Fpay%3F' + id + '&response_type=code&scope=snsapi_base&state=' + id  + '#wechat_redirect'
